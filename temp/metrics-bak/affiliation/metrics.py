...
from .single_ground_truth_event import (
...
def pr_from_events(events_pred, events_gt, Trange):
    ...
    p_precision = [
        affiliation_precision_proba(Is, J, E) for Is, J, E in zip(aff_partition, events_gt, E_gt)
    ]

    p_recall = [
        affiliation_recall_proba(Is, J, E) for Is, J, E in zip(aff_partition, events_gt, E_gt)
    ]
