...
class metricor:
    ...
    def metric_new(self, label, score, plot_ROC=False, alpha=0.2):
        ...
        output:
            dict: 包含以下指标
                ...
                - f_score: F1分数
                - range_recall: 范围召回率
                - existence_reward: 存在奖励
                - overlap_reward: 重叠奖励
                - range_precision: 范围精确率
                - range_f: 范围F1分数
                - precision_at_k: K点精确率
        ...
        metrics_dict = {
            ...
            "recall": recall,
            "f_score": f,
            "range_recall": Rrecall,
            "existence_reward": ExistenceReward,
            "overlap_reward": OverlapReward,
            "range_precision": Rprecision,
            "range_f": Rf,
    ...
    def RangeAUC(self, labels, score, window=0, percentage=0, plot_ROC=False, AUC_type="window"):
        ...
        TPR_list: list[float] = [0]
        FPR_list: list[float] = [0]
        Precision_list: list[float] = [1]
...
def generate_curve(label, score, slidingWindow):
    (
        ...
        avg_auc_3d,
        avg_ap_3d,
    ) = metricor().RangeAUC_volume(labels_original=label, score=score, windowSize=1 * slidingWindow)
